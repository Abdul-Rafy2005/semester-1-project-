...
void save_to_class_file(int recordclass_num, char first_name[], char last_name[], int rollno) {
    if (recordclass_num == 1)
     {
        class_file = fopen("D:\\1st Project\\class1.txt", "a");
    }
     else if (recordclass_num == 2) {
        class_file = fopen("D:\\1st Project\\class2.txt", "a");
    }
     else if (recordclass_num == 3) {
        class_file = fopen("D:\\1st Project\\class3.txt", "a");
    }
     else if (recordclass_num == 4) {
        class_file = fopen("D:\\1st Project\\class4.txt", "a");
    }
     else if (recordclass_num == 5) {
        class_file = fopen("D:\\1st Project\\class5.txt", "a");
    }
     else {
...
void save_student_info_file(struct Student student) {
    ptr = fopen("D:\\1st Project\\STUDENT_INFORMATION.txt", "a");

    if (ptr == NULL) {
        printf("Error opening file STUDENT_INFORMATION.txt\n");
        return;
    }
      // fprintf(ptr, "STUDENT NAME \t CLASS \t ROLL NUMBER\n");
...
printf("\n\tPlease Do not Input any character Otherwise Program will not Work \n\n");
    ...
    if (flag == 1) {
        ptr = fopen("D:\\1st Project\\STUDENT_INFORMATION.txt", "r");
     ...
     do{
        ...
        if (ch >= 1 && ch <= 5) {
            char filename[100];
            sprintf(filename, "D:\\1st Project\\class%d.txt", ch);
